...
class Table:
    def __init__(self, table_number, start_time = 0, end_time = 0, occupied = False):
    ...
    def __repr__(self):
        return "\n------------------------\nTable: {0} \nStart Time: {1}\nEnd Time: {2}\nOccupied: {3}\nTime Played: {4}\n------------------------".format(self.table_number, self.start_time, self.end_time, self.occupied, self.time_played)
